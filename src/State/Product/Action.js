...
import { FIND_PRODUCT_BY_ID_FAILURE, FIND_PRODUCT_BY_ID_REQUEST, FIND_PRODUCT_BY_ID_SUCCESS, FIND_PRODUCTS_FAILURE, FIND_PRODUCTS_REQUEST } from "./ActionType";
...
export const findProducts = (reqData) => async (dispatch) => {
    ...
    try {
        ...
        dispatch({
            type: FIND_PRODUCTS_FAILURE, payload: error.massage
        })
    }
};
