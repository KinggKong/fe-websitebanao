                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        <div className="lg:col-span-2 ">
                            <h1 className="text-lg lg-text-xl font-simibold text-gray-900">UniverSaloutfit</h1>
                            <h1 className='text-lg lg:text-xl test-gray-900 opacity-60 p[t-1'>
                                {product.name}
                            </h1>
                        </div>
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="mt-6">
                                ...
                                <div className='flex items-center space--3'>
                                    ...
                                    <p className='opacity-50 text-sm'>9800 Ratings</p>
                                    <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>389 Reviews</p>
                                </div>
                        ...
                        <Grid container spacing={7}>
                            ...
                            <Grid item xs={5}>
                                ...
                                <div className='flex items-center space-x-3'>
                                    <Rating readOnly precision={.5} value={4.6}></Rating>
                                    <p className='opacity-60'>542353 Rating</p>
                                </div>
                                ...
                                <Box className="mt-5">
                                    ...
                                    <Grid container alignItems="center" gap={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }} variant='determinate' value={25} color='success'></LinearProgress>
                                        </Grid>
                                    </Grid>
                                    {/* Rating 3 Good*/}
                                    <Grid container alignItems="center" gap={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }} variant='determinate' value={50} color='success'></LinearProgress>
                                        </Grid>
                                    </Grid>
                                    {/* Rating 4 Averge*/}
                                    <Grid container alignItems="center" gap={2}>
                                        ...
                                        <Grid item xs={7}>
                                            <LinearProgress sx={{ bgcolor: "#d0d0d0", borderRadius: 4, height: 7 }} variant='determinate' value={30} color='warning'></LinearProgress>
                                        </Grid>
                                    </Grid>
                                    {/* Rating 5 poor*/}
                                    <Grid container alignItems="center" gap={2}>
